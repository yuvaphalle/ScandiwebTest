...
<body>
			...
			<nav class="navbar navbar-expand-lg navbar-light  ">
				<div class="container-fluid ">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<button class="btn btn-outline-success " type="submit" <?php require_once( 'db_connection.php'); $query="SELECT * from products" ; $result=mysqli_query($conn, $query); $rowcount=mysqli_num_rows($result); if ($rowcount>= 12) { ?> disabled
							<?php   }  ?> form="addproduct" ><b>Save</b></button> &nbsp;&nbsp;
						<!-- Cancel Button!-->
						<button class="btn btn-outline-danger " onclick="window.location.href='index.php'"><b>Cancel</b></button>&nbsp;&nbsp; </div>
				</div>
			</nav>
	</header>
	<br>
	...
	<main class="container ">
		<form id="addproduct" method="post" action="addproducts.php">
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control mb-4" id="sku" name="sku" placeholder="SKU" required> </div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label"><b>Name</b></label>
				<div class="col-sm-3">
					<input type="text" class="form-control mb-4" id="name" name="pname" placeholder="Name" required> </div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label"><b>Price ($)</b></label>
				<div class="col-sm-3">
					<input type="number" class="form-control mb-4" id="price" name="price" placeholder="Price ($)" required step="0.01" min="0.01" onkeydown="return event.keyCode !== 69 && event.keyCode !== 187 && event.keyCode !== 189" ">
        </div>
    </div>
    ...
    <div class="form-group row Size box ">
        ...
        <div class="col-sm-3 ">
        <input type="number " class="form-control mb-4 Size rem " id="size " name="size " placeholder="Size in MB " required step="0.1 " min="0.1 "  onkeydown="return event.keyCode !==6 9 && event.keyCode !==1 87 && event.keyCode !==1 89 "">
    ...
    <div class="form-group row Dimension box ">
        ...
        <div class="col-sm-3 ">
        <input type="number " class="form-control mb-4 Dimension rem " id="width " name="width " placeholder="Width in (CM) " required step="0.1 " min="0.1 "  onkeydown="return event.keyCode !==6 9 && event.keyCode !==1 87 && event.keyCode !==1 89 ""> </div>
			</div>
			<div class="form-group row Dimension box">
			...
			<input type="text" class="form-control mb-4 " id="typev" hidden name="typev"> </div>
		</form>
		</div>
		</<br>
